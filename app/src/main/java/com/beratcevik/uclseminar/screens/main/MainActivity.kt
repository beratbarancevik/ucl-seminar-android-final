...
import com.beratcevik.uclseminar.screens.stockdetail.StockDetailFragment
...
class MainActivity : AppCompatActivity() {
    ...
    fun navigateToDetail(stock: Stock) {
        supportFragmentManager.commit {
            replace(R.id.fragmentContainer, StockDetailFragment.newInstance(stock.id))
            addToBackStack(null)
        }
